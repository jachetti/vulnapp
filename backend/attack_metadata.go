...
var AllAttacks = []AttackScenario{
	...
	},
	{
		...
		Name:        "🎓 Scenario 3: Credential Theft (50 pts)",
		Category:    "Learning Scenarios",
		Description: "Credentials in different places (env vars, K8s secrets). Endpoint parallel: Mimikatz, /etc/shadow, SSH keys. Teaches: Where credentials hide in containers. Flag: FLAG{credentials_hidden_in_environment_variables}",
		ScriptPath:  "/bin/learning/03_Credential_Theft.sh",
		MitreTactics: []string{"TA0006"},
		MitreTechniques: []MitreTechnique{
	...
	},
	{
		...
		Name:        "🎓 Scenario 4: Container Escape (100 pts)",
		Category:    "Learning Scenarios",
	...
	},
	{
		...
		Name:        "🎓 Scenario 5: Docker Socket Exploitation (150 pts)",
		Category:    "Learning Scenarios",
		Description: "API abuse for instant host root. Shows: 30-second path from container → host root. Endpoint parallel: Finding domain admin credentials. Flag: FLAG{docker_socket_gives_root_access_to_everything}",
		ScriptPath:  "/bin/learning/05_Docker_Socket.sh",
		MitreTactics: []string{"TA0004"},
		MitreTechniques: []MitreTechnique{
			{ID: "T1611", Name: "Escape to Host"},
		},
	...
	},
	{
		...
		Name:        "🎓 Scenario 6: Kubernetes API Exploitation (200 pts)",
		Category:    "Learning Scenarios",
		Description: "Service account token theft → cluster compromise. #1 Kubernetes attack vector. Endpoint parallel: Every process having domain admin credentials. Teaches: RBAC importance. Flag: FLAG{kubernetes_token_equals_cluster_admin_oops}",
		ScriptPath:  "/bin/learning/06_Kubernetes_API.sh",
		MitreTactics: []string{"TA0006", "TA0007"},
		MitreTechniques: []MitreTechnique{
			{ID: "T1552.007", Name: "Unsecured Credentials: Container API"},
			{ID: "T1613", Name: "Container and Resource Discovery"},
		},
	...
	},
	{
		...
		Name:        "🎓 Scenario 7: Full Attack Chain (300 pts)",
		Category:    "Learning Scenarios",
